---
name: "source-command-api-toolkit"
description: "Check API toolkit installation and load general context"
---

# source-command-api-toolkit

Use this skill when the user asks to run the migrated source command `api-toolkit`.
...
3. `api-toolkit/AGENTS.md` - This file (guidance for Codex)

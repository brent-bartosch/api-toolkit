...
class Config:
    ...
    SERVICES = {
        ...
        "klaviyo": {
            ...
            "lists": {"example_list": "your-list-id"},
            "flows": {"example_flow": "your-flow-id"},
            "token_cost": 500,
        },
        "render": {"env_vars": ["RENDER_API_KEY"], "token_cost": 400},
        "brightdata": {"env_vars": ["BRIGHTDATA_API_KEY"], "token_cost": 500},
        "shopify": {
